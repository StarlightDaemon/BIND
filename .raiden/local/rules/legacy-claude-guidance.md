<!--
Origin: root CLAUDE.md
Moved: 2026-07-09 (Edict v2.0.0 CLAUDE.md-pointer rule fold-in)
The model-routing sections below (Model naming, Gemini prompt format) are
superseded by .raiden/local/ROUTING.md but are preserved here verbatim.
-->
