  ...
  return (
    <BindShell>
      ...
      <div style={{ marginTop: 20 }}>
        <Tabs defaultValue="scraping" variant="outline">
          <Tabs.List>
            <Tabs.Tab value="scraping">Scraping</Tabs.Tab>
            <Tabs.Tab value="network">Network</Tabs.Tab>
            <Tabs.Tab value="trackers">Trackers</Tabs.Tab>
            <Tabs.Tab value="access">Access &amp; Security</Tabs.Tab>
          </Tabs.List>

          {/* ── Scraping ─────────────────────────────────────────────────── */}
          <Tabs.Panel value="scraping" pt="md">
          ...
          <Tabs.Panel value="network" pt="md">
            <FormShell onSubmit={handleConfig} submitLabel="Save & Restart" loading={savingCfg}>
              ...
              <Field label="Proxy List (optional)" helper="Comma-separated proxy URLs. Overrides single proxy above.">
          ...
          <Tabs.Panel value="access" pt="md">
            ...
            <div style={{ marginTop: 32, paddingTop: 24, borderTop: '1px solid var(--fujin-border-subtle)' }}>
